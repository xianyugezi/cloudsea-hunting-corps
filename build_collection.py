...
用途
----
`云海猎团_QQ群回合制RPG_PvE设计稿.md` 是 `云海猎团/` 下各分章的**单文件副本**。
...
COLLECTION = HERE.parent / "云海猎团_QQ群回合制RPG_PvE设计稿.md"
...
CHAPTERS = [
    ...
    ("15_主线章节与难度阶段.md",          "十四", "主线章节与难度阶段（七章十三节 × 潮位五阶）"),
]
...
> - `15_主线章节与任务/` —— 14 张章节任务卡（七章十三节 + 潮位五终局层），共约 2,400 行，含 **335 条任务**（主线 97 ／ 支线 238）的逐条清单。
>
> 上述两册的**总纲仍在本合集中**：职业见「二、十四职业 × 流派 × 武器解耦」，章节任务见「十四、主线章节与难度阶段」。
